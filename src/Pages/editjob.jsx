...
const Editjob = ({updatejob}) => {
  ...
  const [Companyphone , setCompanyphone] = useState(jobs.company.contactPhone);
  ...
  const submitform = (e) =>{
    ...
    const job = {
      id,
      title,type,description,location,salary,company:{
        Companyname,Companydescription,Contactemail,Companyphone
      }
